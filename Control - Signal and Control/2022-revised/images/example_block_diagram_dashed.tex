\begin{tikzpicture}[auto, node distance=2cm,>=latex',line width=1pt]
    ...
    \draw[red, dashed] ([xshift=-3mm, yshift=5mm]sum2.west) -- ([xshift=3mm, yshift=5mm]right2con2.east) |- ([yshift=-3mm]controller3.south) -| node[below]{$H(s)$} ([xshift=-3mm, yshift=5mm]sum2.west);
\end{tikzpicture}